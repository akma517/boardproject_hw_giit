...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/member.css">s
</head>
<body>
<%
	/* 사전 작업 */
	...
	<div class="container-fluid pt-3">
		...
		%>
			<div class="center-block text-center" style="width:300px; padding:15px;">
				<h1>비밀번호 수정</h1>
				<form class="form-group" method="post" action="<%=request.getContextPath()%>/member/updateMemberPwAction.jsp">
					<div>현재 비밀번호 : </div>
