			...
			<tbody>
				...
				<tr>
					<td class="text-right" colspan="5">
						<a href="<%=request.getContextPath() %>/index.jsp" class="btn btn-outline-primary btn-sm">index로</a>
						<a href="<%=request.getContextPath() %>/member/updateMemberPwForm.jsp" class="btn btn-outline-primary btn-sm">비밀번호 수정</a>
						<a href="<%=request.getContextPath() %>/member/updateMemberForm.jsp" class="btn btn-outline-primary btn-sm">기타정보 수정</a>
						<a href="<%=request.getContextPath() %>/member/deleteMemberForm.jsp" class="btn btn-outline-danger btn-sm">회원탈퇴</a>
					</td>
				</tr>
			</tbody>
		</table>
