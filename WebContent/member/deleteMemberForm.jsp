...
%>
	<div class="container-fluid pt-3">
		...
		<!-- 서브메뉴 종료 -->
		<div class="container pt-3 center-block" style="width:33px; padding:15px;">
		<%
		...
		%>
			<div class="center-block text-center" style="width:300px; padding:15px;">
				<h1>회원탈퇴</h1>
				<form class="form-group" method="post" action="<%=request.getContextPath()%>/member/deleteMemberAction.jsp">
					<div>회원탈퇴를 원하신다면 비밀번호를 입력해 주세요. : </div>
					<div><input class="form-control" type="password" name="memberPw"></div>
					<br>
					<div><input class="btn btn-outline-danger" type="submit" value="회원탈퇴"></div>
				</form>
				<%
